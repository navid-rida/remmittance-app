...
def download_voucher(request, pk):
    ...
    cash_incentive_taka, cash_incentive_ps = (int(rem.cash_incentive_amount//1), int(Decimal(rem.cash_incentive_amount%1)*100)) if rem.check_unpaid_cash_incentive() else (0,0)
