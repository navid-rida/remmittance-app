...
passport_re = RegexValidator(
    _lazy_re_compile(r'^[0-9a-zA-Z]{2}[0-9]{7}$'),
...
fdd_number_re = RegexValidator(
    _lazy_re_compile(r'^[0-9a-zA-Z-]{1,20}$'),
    message=_('Please enter a valid FDD/RTGS ref number'),
    code='invalid_cdr',
)
...
nrbc_acc = RegexValidator(r'^(0|3|5|6)[0-9][0-9][0-9][2|3|5][0-9]{10}$', 'Please provide a valid NRBC account number')
nrbc_fc_acc = RegexValidator(r'^0[1-9][0-8][0-9]2[0-9]{10}$', 'Please provide a valid NRBC FC account number')
