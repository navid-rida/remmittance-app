...
def remittance_rit_list(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            query_set = Remmit.objects.filter(cashincentive__entry_category='P', cashincentive__date_cash_incentive_settlement__isnull=False)
            if date_from and date_to:
                query_set = query_set.filter(cashincentive__date_cash_incentive_settlement__range=(date_from,date_to))
            ...
            statement = remittance_rit(qset=query_set)
